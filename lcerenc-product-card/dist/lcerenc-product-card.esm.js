...
var useProduct = _ref => {
  ...
  var [counter, setCounter] = useState((initialValues == null ? void 0 : initialValues.count) || value);
...
var ProductTitle = _ref => {
  ...
  var titleToShow = title ? title : product.title;
...
var ProductImage = _ref => {
  ...
  var imageToShow = img$1 ? img$1 : product.img;
  return React.createElement("img", {
    className: styles.productImg + " " + className,
    src: imageToShow ? imageToShow : img,
    alt: "Product",
    style: style
  });
};
...
//# sourceMappingURL=lcerenc-product-card.esm.js.map
